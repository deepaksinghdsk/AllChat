...
class RecyclerAdapter extends
    ...
    RecyclerAdapter(Context c) {
        ...
        makeConnectionService.setFragment1(this); //this will initialise updater of makeConnectionService.java class
        addChats.setFragment1(this); //this will initialise updater of addChats.java class
        ...
        File file = new File(root, "usersInfo");
        try {
            if (!file.exists()) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.itemName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                System.out.println("Position = " + position + ", name = " + info.getName() + " and Recipients id is :" + info.getRid());
